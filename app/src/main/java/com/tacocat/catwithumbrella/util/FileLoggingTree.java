package com.tacocat.catwithumbrella.util;
...
public class FileLoggingTree extends Timber.DebugTree {
    ...
    protected void log(int priority, String tag, String message, Throwable t) {
        ...
        try {
            ...
            File direct = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/CatWithUmbrellaLogs");
            ...
            File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/CatWithUmbrellaLogs" + File.separator + fileName);
